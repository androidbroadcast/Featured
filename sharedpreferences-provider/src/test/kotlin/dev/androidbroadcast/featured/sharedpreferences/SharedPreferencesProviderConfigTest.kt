...
class SharedPreferencesProviderConfigTest {
    ...
    @Test
    fun `test get returns null when value does not exist`() = runTest {
    ...
    @Test
    fun `test set and get string value`() = runTest {
    ...
    @Test
    fun `test set and get int value`() = runTest {
        // Given an int value
        val testValue = 999
    ...
    @Test
    fun `test set and get boolean value`() = runTest {
    ...
    @Test
    fun `test set and get float value`() = runTest {
        // Given a float value
    ...
    @Test
    fun `test set and get long value`() = runTest {
        // Given a long value
    ...
    @Test
    fun `test set and get double value`() = runTest {
    ...
    @Test
    fun `test clear all values`() = runTest {
    ...
    @Test
    fun `test observe value changes`() = runTest {
        // Given initial value
    ...
    @Test
    fun `test observe does not emit for different keys`() = runTest {
    ...
    @Test
    fun `test overwrite existing value`() = runTest {
    ...
    @Test
    fun `test multiple parameters with same value type`() = runTest {
    ...
    @Test
    fun `test exception for unsupported type`() = runTest {
