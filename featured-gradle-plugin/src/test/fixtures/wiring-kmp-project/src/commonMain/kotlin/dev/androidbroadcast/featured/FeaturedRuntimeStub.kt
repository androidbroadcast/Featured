 ...
 * extensions into this module's compilation. Those generated sources `import
 ...
 * symbols the generator emits so the generated sources compile, exercising generated-code
 * compilation as proof the wiring happened. The API surface is derived from ConfigParamGenerator /
 * ExtensionFunctionGenerator and kept in lockstep with the real `:core` types.
 */
